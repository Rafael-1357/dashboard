      ...
      <div className='relative'>
        {loading && (
          <div className="absolute inset-0 bg-white/70 dark:bg-slate-900/70 flex items-center justify-center z-10">
            <span className="text-slate-500 animate-pulse">Atualizando...</span>
          </div>
        )}
        ...
        </CardHeader>
        {
          productInfos != null && productInfos.data.length > 0 ? (
            ...
            <div className="p-4 text-muted-foreground text-center">Nenhum lote encontrado para o produto selecionado.</div>
          )
        }
      </div>
    </Card >
